...
package org.jraf.nyan.timelog

import java.io.File
import java.util.Calendar
import com.google.gson.Gson
import org.jraf.nyan.util.Millisecond
import org.jraf.nyan.util.Timestamp
...
object TimeLog {
    ...
    private val persistedStateFile by lazy {
        val nyanDir = File(System.getProperty("user.home"), ".nyan")
        nyanDir.mkdirs()
        File(nyanDir, "timelog.json")
    }
